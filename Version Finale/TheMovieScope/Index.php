    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto">
            <li class="nav-item"><a class="nav-link active">
                    <button style="color:white; background-color:transparent;border-color:transparent" id="sign_button"
                            onclick="sign()">S'inscrire
                    </button>
                </a></li>
        </ul>
    </div>
...
<section class="login-dark">
    <div id="connexion" style="display: block;">
        ...
        <form action="Traitement.php" method="post">
            ...
            <?php
            //Affichage d'un texte en fonction de l'action de Traitement.php ou Creation.php
            ...
            <div class="mb-3"><input class="form-control d-lg-flex" type="password" id="mdp" name="mdp"
                                     placeholder="Password"></div>
            <div class="mb-3">
                <button class="btn btn-primary d-block w-100" type="button" onclick="VerifierLogin(this.form)">
                    Connexion
                </button>
            </div>
        </form>
    ...
    <div id="inscription" style="display: none">
        <form action="Creation.php" method="post">
            ...
            <div class="mb-3"><input class="form-control" type="text" name="prenom" id="prenom" placeholder="Prenom">
            </div>
            <div class="mb-3"><input class="form-control d-lg-flex" type="password" name="mdp" id="mdp" name="password"
                                     placeholder="Mot de passe"></div>
            <div class="mb-3"><input class="form-control d-lg-flex" type="password" name="conf" id="conf" name="conf"
                                     placeholder="Confirmation"></div>
            <div class="mb-3">
                <button class="btn btn-primary d-block w-100" type="button" onclick="VerifierInscription(this.form)">
                    S'inscrire
                </button>
            </div>
        </form>
