...
while($donnee = $rep->fetch())
{
    ...
    echo '<td><a href="Modification.php?id='.$donnee['idFilm'].'&genre=film" class="mod" style="display: none">Modifier</a></td>';
    echo '</tr>';
}
echo'</table>';
...
while($donnee = $rep->fetch())
{
    ...
    echo '<td><a href="Modification.php?id='.$donnee['idArtiste'].'&genre=artiste" class="mod" style="display: none">Modifier</a></td>';
    echo '</tr>';
}
echo'</table>';
...
while($donnee = $rep->fetch())
{
    ...
    echo '<td><a href="Modification.php?id='.$donnee['idGenre'].'&genre=genre" class="mod" style="display: none">Modifier</a></td>';
    echo '</tr>';
}
echo'</table>';
...
<script>
    function Menu_film() {
        ...
        document.getElementById("table_internautes").setAttribute("style","display:none");
            ...
            for(let i=0;i<document.getElementsByClassName('mod').length;i++)
                document.getElementsByClassName('mod')[i].setAttribute("style","display:none");
        }
        ...
        if(document.getElementById("film").value==="Modifier"){
            document.getElementById("table_film").setAttribute("style","display:block");
            document.getElementById("table_artiste").setAttribute("style","display:none");
            document.getElementById("table_genre").setAttribute("style","display:none");
            document.getElementById("table_internautes").setAttribute("style","display:none");
            ...
            for(let i=5;i<document.getElementsByTagName('button').length;i++)
                document.getElementsByTagName('button')[i].setAttribute("style","display:none");
            for(let i=0;i<document.getElementsByClassName('mod').length;i++)
                document.getElementsByClassName('mod')[i].setAttribute("style","display:block");
        }
    ...
    function Menu_artiste() {
        ...
        if(document.getElementById("artiste").value==="Modifier"){
            document.getElementById("table_film").setAttribute("style","display:none");
            document.getElementById("table_artiste").setAttribute("style","display:block");
            document.getElementById("table_genre").setAttribute("style","display:none");
            document.getElementById("table_internautes").setAttribute("style","display:none");
    ...
    function Menu_genre() {
        ...
        if(document.getElementById("genre").value==="Modifier"){
            document.getElementById("table_film").setAttribute("style","display:none");
            document.getElementById("table_artiste").setAttribute("style","display:none");
            document.getElementById("table_genre").setAttribute("style","display:block");
            document.getElementById("table_internautes").setAttribute("style","display:none");
    ...
    function Menu_internautes() {
        ...
        if(document.getElementById("internautes").value==="Modifier"){
            document.getElementById("table_film").setAttribute("style","display:none");
            document.getElementById("table_artiste").setAttribute("style","display:none");
            document.getElementById("table_genre").setAttribute("style","display:none");
            document.getElementById("table_internautes").setAttribute("style","display:block");
