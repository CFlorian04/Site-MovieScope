...
INSERT INTO `genre` VALUES (1,'Action'),(2,'Horreur'),(3,'Comedie'),(4,'Dramatique'),(5,'Fiction'),(6,'Peplum'),(7,'Thriller'),(8,'Guerre'),(23,'Drame');
...
INSERT INTO `internaute` VALUES (1,'Mohammed','Tobji','mohammed.tobji@lycee-jeanrostand.fr','tobji1234',1),(2,'Mohamed','Madani','mohamed.madani@lycee-jeanrostand.fr','madani1111',0),(3,'Admin','Test','admin','1234',1),(4,'Internaute','Test','internaute','1234',0),(7,'Florian','Dauvergne','flo.dauv@orange.fr','1234',1),(8,'Florian','Codebecq','florian.codebecq@lycee-jeanrostand.fr','flo123',0),(9,'Hazim','Ahmed-Salih','hazim.ahmedsalih@lycee-jeanrostand.fr','hazim',0);
...
INSERT INTO `noter` VALUES (1,1,9,'Super Film ! C\'est un chef d\'oeuvre intemporelle !'),(1,4,8,'Ce film nous plonge dans une histoire et époque époustouflante ! Incroyable !'),(1,7,5,'Malgré des effets spéciaux incroyable, l\'histoire du film est selon moi plus que baclé.'),(2,47,7,'Une histoire qui est bien raconté malgré certaines scène qui dure trop longtemps pour pas grand choses.'),(2,48,9,'Un film prenant et qui fait rendre compte des enjeux de l\'Humanité.'),(2,50,4,'Dommage que le film ne parle de certain enjeux qui aurais été plus intéressant à évoquer.'),(7,7,8,'Une histoire prenante et des effets spéciaux incroyables'),(7,9,8,'L\'univers de ce film est tous simplement bouleversant !'),(7,44,10,'La réalisation de ce film est juste incroyable ! Difficile de faire mieux !'),(8,46,8,'Un film incontournable et éternel !'),(8,48,9,'L\'histoire et le déroulement du film est juste incroyable. L\'atmosphère et pesante et cela se ressent.'),(9,3,7,'Un classique du cinéma ! À la fois effrayant et bien rythmé.'),(9,6,9,'L\'histoire et la mise en scène globale est parfaitement exécutée ! Film Incroyable');
...
-- Dump completed on 2022-01-08 21:13:56
