...
<div>
    <table>
        <tr>
            <th ><button onclick="Menu_film()">Lire<a href="Ajout.php?action=film"><button>Ajout</button></a></th>
            <th ><button onclick="Menu_artiste()">Lire<a href="Ajout.php?action=artiste"><button>Ajout</button></a></th>
            <th ><button onclick="Menu_genre()">Lire<a href="Ajout.php?action=genre"><button>Ajout</button></a></th>
